...
describe("prettytypes-ng CommonType tests", function () {
    ...
    beforeEach( inject(function( _IdentifierSvce_, _RecorderSvce_, _CommonType_) {
        ...
        // console.log( "typeof aModule_CommonType= " + typeof _CommonType_);
        // console.log( "anIdentifier aModule_CommonType = " + Object.keys( _CommonType_));
