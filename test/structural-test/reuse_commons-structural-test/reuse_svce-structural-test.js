...
describe("prettytypes-ng ReuseSvce structural tests", function () {
    ...
    var aReuseSvce_title = "CommonSvce-Title-test";


    beforeEach( inject(function( _ReuseSvce_){

        aReuseSvce = _ReuseSvce_;

        // console.log( "typeof aReuseSvce= " + typeof aReuseSvce);
        // console.log( "aReuseSvce keys = " + Object.keys( aReuseSvce));
    ...
    for( var aReuseSvceMethodNameIdx=0; aReuseSvceMethodNameIdx < aNumCommonSvceMethodNames; aReuseSvceMethodNameIdx++) {
        var aReuseSvceMethodName = someCommonSvceMethodNames[ aReuseSvceMethodNameIdx];
